...
class _AnimeDetailsPageState extends State<AnimeDetailsPage> {
  ...
  Widget _buildCoverWithSideInfo() {
    ...
    String seasonText = "SEASON\n" + widget.animeData!.season + " " + widget.animeData!.year.toString();
    ...
    if(widget.animeData!.episodeCount != null && widget.animeData!.episodeMinutes != null) {
      ...
      formatText += " eps of " + widget.animeData!.episodeMinutes.toString() + "min";
    }
  ...
  Widget _buildTitleBlock() {
    ...
    formattedGenres = formattedGenres.substring(3); // remove the " - " characters added by the first element
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              if(formattedGenres.isNotEmpty) Text(formattedGenres, textAlign: TextAlign.center,),
            ]));
